            ...
            <div class="product-image" >
              ...
              <div class="shadow" ></div>
                <div class="detail-link " @click="moreInfo(film.filmId)" title="Подробнее">
                  ...
                  <span class="title">Жанры:</span> <p v-for=" genre in film.genres" :key="genre.id" style="margin-bottom: 0px">{{ genre.genre }}</p>
                </div>
            </div>
          </div>
         </li>
...
export default {
    ...
    mounted: function(){
      this.checkPlace(1)
      axios.get('https://kinopoiskapiunofficial.tech/' + this.secondApi, 
      {
